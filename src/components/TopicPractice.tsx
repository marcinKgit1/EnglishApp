...
export function TopicPractice({ branch, levelTitle, onBack }: TopicPracticeProps) {
  ...
  return (
    <div className="max-w-3xl mx-auto py-8">
      ...
      <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl p-8 rounded-2xl shadow-[0_8px_32px_0_rgba(31,38,135,0.05)] border border-white/50 dark:border-slate-700/50 mb-8 text-center relative overflow-hidden transition-colors">
        ...
        <h2 className="text-4xl font-bold text-slate-900 dark:text-white mb-2">{branch.title}</h2>
        <p className="text-lg text-slate-500 dark:text-slate-400 max-w-xl mx-auto">{branch.focus || branch.when}</p>
      </div>
      ...
      <div className="bg-indigo-50/80 dark:bg-indigo-900/20 backdrop-blur-md border border-indigo-200/50 dark:border-indigo-800/50 p-4 rounded-xl mb-8 flex gap-3 items-start transition-colors">
        ...
        <div>
          <h4 className="font-semibold text-indigo-900 dark:text-indigo-300">Jak ćwiczyć?</h4>
          <p className="text-indigo-800 dark:text-indigo-200/80 text-sm mt-1">
            Przetłumacz poniższe zdania na język angielski. Jeśli nie znasz jakiegoś słowa, <b>kliknij na nie</b> w polskim zdaniu, aby otrzymać tłumaczenie. Możesz poprosić o podpowiedź lub sprawdzić swoje tłumaczenie lokalnie.
          </p>
        </div>
      </div>
