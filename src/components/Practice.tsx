      ...
      <div className="bg-amber-50/80 dark:bg-amber-900/20 backdrop-blur-md border border-amber-200/50 dark:border-amber-800/50 p-4 rounded-xl mb-8 flex gap-3 items-start transition-colors">
        ...
        <div>
          ...
          <p className="text-amber-800 dark:text-amber-300/80 text-sm mt-1">
            Przetłumacz poniższe zdania na język angielski używając słowa "
            {word.english}". Jeśli nie znasz jakiegoś słowa,{" "}
            <b>kliknij na nie</b> w polskim zdaniu, aby otrzymać tłumaczenie.
            Możesz poprosić o podpowiedź lub sprawdzić swoje tłumaczenie
            lokalnie.
          </p>
        </div>
      </div>
